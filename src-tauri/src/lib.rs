...
//! CONTRACT:
//! - GUARANTEES: single instance; tray controls; `get_idle_secs` reports Windows idle seconds; reminder window never steals focus; `--minimized` login launch stays in tray.
